    ...
    sidebar: [
      { text: "入门", collapsed: false, items: [
        ...
        { text: "第二章 环境搭建", collapsed: true, items: [
          ...
          { text: "tsconfig.json", link: "/ch02#tsconfig-json" },
        ...
        { text: "第三章 JS 快速补课", collapsed: true, items: [
          ...
          { text: "变量声明", link: "/ch03#变量声明" },
          { text: "基本类型", link: "/ch03#基本类型" },
          { text: "模板字符串", link: "/ch03#模板字符串" },
        ...
        { text: "第四章 基础类型系统", collapsed: true, items: [
          ...
          { text: "联合类型", link: "/ch04#联合类型" },
          { text: "类型别名", link: "/ch04#类型别名" },
          { text: "any", link: "/ch04#any" },
          { text: "unknown", link: "/ch04#unknown" },
          { text: "void、never、undefined", link: "/ch04#void、never、undefined" },
          { text: "字面量类型", link: "/ch04#字面量类型" },
          { text: "as const", link: "/ch04#as-const" },
          { text: "enum", link: "/ch04#enum" },
      ...
      { text: "核心", collapsed: false, items: [
        { text: "第五章 函数类型", collapsed: true, items: [
          ...
          { text: "调用签名", link: "/ch05#调用签名" },
          { text: "构造签名", link: "/ch05#构造签名" },
          { text: "泛型函数", link: "/ch05#泛型函数" },
          { text: "回调函数的参数最佳实践", link: "/ch05#回调函数的参数最佳实践" },
          { text: "void 与 undefined", link: "/ch05#void-与-undefined" },
          { text: "函数重载的编写指南", link: "/ch05#函数重载的编写指南" },
          { text: "剩余参数与展开", link: "/ch05#剩余参数与展开" },
          { text: "参数解构的类型注解", link: "/ch05#参数解构的类型注解" },
          { text: "async 与 Promise", link: "/ch05#async-与-promise" },
        ...
        { text: "第六章 对象类型与接口", collapsed: true, items: [
          ...
          { text: "type vs interface", link: "/ch06#type-vs-interface" },
          { text: "索引签名", link: "/ch06#索引签名" },
          { text: "多余属性检查", link: "/ch06#多余属性检查" },
          { text: "扩展类型", link: "/ch06#扩展类型" },
          { text: "交叉类型", link: "/ch06#交叉类型" },
          { text: "泛型对象类型", link: "/ch06#泛型对象类型" },
          { text: "元组类型", link: "/ch06#元组类型" },
          { text: "本章练习", link: "/ch06#本章练习" },
        ] },
        { text: "第七章 类型收窄", collapsed: true, items: [
          { text: "联合类型", link: "/ch07#联合类型" },
          { text: "类型收窄", link: "/ch07#类型收窄" },
          { text: "可辨识联合", link: "/ch07#可辨识联合" },
          { text: "穷尽性检查", link: "/ch07#穷尽性检查" },
        ...
        { text: "第八章 推导与断言", collapsed: true, items: [
          ...
          { text: "类型断言", link: "/ch08#类型断言" },
          { text: "@ts-expect-error", link: "/ch08#ts-expect-error" },
          { text: "非空断言", link: "/ch08#非空断言" },
      ...
      { text: "进阶", collapsed: false, items: [
        ...
        { text: "第十章 类", collapsed: true, items: [
          ...
          { text: "存取器", link: "/ch10#存取器" },
          { text: "private 与 #", link: "/ch10#private-与" },
      ...
      { text: "提高", collapsed: false, items: [
        ...
        { text: "第十四章 Zod 运行时验证", collapsed: true, items: [
          ...
          { text: "Schema 类型推断", link: "/ch14#schema-类型推断" },
      ...
      { text: "练习与附录", collapsed: false, items: [
        ...
        { text: "附录 A tsconfig 配置", collapsed: true, items: [
          { text: "前端项目配置", link: "/appendix-a#前端项目配置" },
          { text: "Node.js / 库项目", link: "/appendix-a#node-js-库项目" },
          { text: "严格模式全家桶", link: "/appendix-a#严格模式全家桶" },
          { text: "TS 6.0/7.0 主要变更", link: "/appendix-a#ts-6-0-7-0-主要变更" },
        ] },
        { text: "附录 B 工具类型", link: "/appendix-b" },
